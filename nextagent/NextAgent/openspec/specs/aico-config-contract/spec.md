# aico-config-contract Specification

## Purpose
Define the frontend-only AICOConfig contract for host-supplied UI customization, including supported fields, injection paths, hand-written validation rules, and default behavior when configuration is absent or invalid.
