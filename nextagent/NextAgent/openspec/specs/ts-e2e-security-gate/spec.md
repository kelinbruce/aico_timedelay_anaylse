...
Define real-boundary security E2E gate that verifies security properties (auth, attachment, sandbox, provider error mapping, audit/log safety) across real process, network, filesystem, and sink boundaries.
