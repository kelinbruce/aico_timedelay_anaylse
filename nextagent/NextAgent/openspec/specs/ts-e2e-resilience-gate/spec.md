...
Define real-fault resilience E2E gate that verifies recovery invariants (stream replay, process restart, non-idempotent guard) using real stream connections, real process lifecycle, and real persistence.
