# agent-web-complaint-feedback Specification

## Purpose

定义浏览器前端答案投诉反馈与投诉历史查看能力：进入服务时探测投诉类型配置并控制投诉能力可见性，在已完成助手答案上提供投诉反馈图标，点击后打开投诉中心弹框提交投诉，并在 immersive/collaborative 多宿主中提供投诉历史入口（复用 PIU 渲染）。该能力只拥有前端投影与交互，投诉提交与历史由外部 REST 服务承载。
## Requirements
