...
## Purpose
Define the stable contract for owner-scoped and agent-scoped session deletion, including the Web delete API, runtime/session boundary ownership, active-run conflict protection, composite gateway deletion, and frontend list refresh behavior.
