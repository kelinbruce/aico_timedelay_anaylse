...
This specification defines the stable visual style requirements for the web chat conversation pane, including theme-aware pane, bubble, and answer colors.
