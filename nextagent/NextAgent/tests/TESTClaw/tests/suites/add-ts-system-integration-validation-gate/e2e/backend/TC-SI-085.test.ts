/**
 * E2E Case: TC-SI-085 ToolSearch safe governed metadata.
...
describe('TC-SI-085 ToolSearch safe governed metadata', () => {
  it('TC-SI-085', async () => runCapabilityCase('TC-SI-085'), 180_000);
});
