/**
 * E2E Case: TC-SI-089 workspace tool calling product path.
...
describe('TC-SI-089 workspace tool calling product path', () => {
  it('TC-SI-089', async () => runCapabilityCase('TC-SI-089'), 180_000);
});
