/**
 * E2E Case: TC-SI-053 pending input answer round trip.
...
describe('TC-SI-053 pending input answer round trip', () => {
  it('TC-SI-053', async () => runCapabilityCase('TC-SI-053'), 180_000);
});
