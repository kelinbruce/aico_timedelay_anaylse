...
This specification defines the stable visual style requirements for the web chat composer send and stop buttons, including theme-aware icons, labels, and button styling.
