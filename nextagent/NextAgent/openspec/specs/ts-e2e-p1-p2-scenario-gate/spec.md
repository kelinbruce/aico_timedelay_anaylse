...
Define the stable `P1/P2` scenario E2E gate contract for real-boundary case admission, unique case ownership, and safe machine-readable gate evidence before release qualification consumes the gate result.
